function [devices, QuitSignal,varargout] = getDevID3(varargin)
try
    fprintf('\n\n---------------------Getting Device IDs---------------------\n')
    %% ------------------------ INPUTS ------------------------ % %
    trigger  = varargin{1};     % % trigger  : 1 = apple keyboard | 2 = scanner pulse | 3 = A4Tech keyboard | 4 = Dell
    response = varargin{2};     % % response : 1 = apple keyboard | 2 = old response boxes | 3 = NNL Grips | 4 = Current designs button boxes.| 5 = A4Tech | 6 = Dell
    ...
    possibleTrigs = {'Apple, Inc','NOVATEK', 'A4Tech','Dell'};
    possibleResp  = {'Apple, Inc','P.I. Engineering', 'Code Mercenaries', 'Current Designs, Inc.','A4Tech','Dell'};
