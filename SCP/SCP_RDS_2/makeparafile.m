function [FSFASTPARAFILE] = makeparafile(SUBNO, RUNNO,BLOCKDUR, ANSDUR, FIXDUR, CONDCODE,  PRACTICE)
fprintf('%s \n',mfilename())
try
    if ~PRACTICE
        ...
        OUTPUTFNAME = sprintf('%s/SCP_RDS_%i_%i.para', OUTPUTDIR ,SUBNO, RUNNO);
